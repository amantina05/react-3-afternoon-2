...
class Search extends Component {
  ...
  search(event) {
    ...
    axios
      .get(`/api/${this.state.searchType}?q=${this.state.searchTerm}`)
      .then(results => {
      ...
      <div className="content search-view">
        <form className="search-group" onSubmit={e => this.search(e)}>
          ...
          <div className="search-type">
            <span>
              <input
                defaultChecked={this.state.searchType === 'blogs'}
                type="radio"
                name="searchType"
                value="blogs"
            ...
            <span>
              <input
                defaultChecked={this.state.searchType === 'users'}
                type="radio"
                name="searchType"
                value="users"
                onChange={e => this.changeSearchType(e.target.value)}
        ...
        <div className="blog-list">
          ...
          {blogResults.length || userResults.length ? null : (
            <p style={{ alignSelf: 'top', justifySelf: 'center' }}>
              No results fit your search.
            </p>
          )}
        </div>
      </div>
