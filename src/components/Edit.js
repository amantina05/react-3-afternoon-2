    ...
    axios
      ...
      .then(results => {
        this.setState({
          ...
          original: results.data.original,
        });
      })
      .catch(console.log);
  }
      ...
      <div className="content">
        <div className="add-blog">
          ...
          <div className="input-group">
            ...
            <input
              value={subTitle}
              onChange={e => this.subTitleChange(e.target.value)}
              type="text"
            />
          </div>
          <div className="input-group">
          ...
          <div className="buttons">
            <button onClick={_ => this.delete()} className="delete-button">
              Delete
            </button>
            <button onClick={_ => this.cancel()} className="cancel-button">
              Cancel
            </button>
